    ...
    return (
        <section className="bg-zinc-300 text-center text-1rem">
            <div className="text-balance w-full sm:w-9/12 mx-auto">
                ...
                <p><span className="font-semibold">ADVERTISING DISCLOSURE:</span> This website and the products & services referred to on the site are advertising marketplaces. This website is an op ad and not a news publication. Any photographs of persons used on this site are models. The owner of this site and of the products and services referred to on this site only provides a service where consumers can obtain and compare.</p>
